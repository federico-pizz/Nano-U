...
def main():
    ...
    img_dir = os.path.join(root_dir, "data", "TinyAgri", "Tomatoes", "scene2")
    ...
    ##########################root_dir, #### CHANGE ALSO HERE BASED ON THE FOLDER ###############################
    ...
    csv_filepath = os.path.join(root_dir, "data", "csv", "line_points_ts2.csv")
