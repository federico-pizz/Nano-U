...
f1 = os.path.join(root_dir, "data/TinyAgri/Tomatoes/", "scene1")
f2 = os.path.join(root_dir, "data/TinyAgri/Tomatoes/", "scene2")
f3 = os.path.join(root_dir, "data/TinyAgri/Crops/", "scene1")
f4 = os.path.join(root_dir, "data/TinyAgri/Crops/", "scene2")

# import all the masks from the folders
m1 = os.path.join(root_dir, "data/masks/", "Tomatoes/scene1")
m2 = os.path.join(root_dir, "data/masks/", "Tomatoes/scene2")
m3 = os.path.join(root_dir, "data/masks/", "Crops/scene1")
m4 = os.path.join(root_dir, "data/masks/", "Crops/scene2")
