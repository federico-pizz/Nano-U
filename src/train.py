...
def train(model, device, criterion, epochs: int=1, learning_rate: float=1e-5, batch_size: int=1, teacher_model=None, distill_alpha=0.5, distill_temp=2.0):
    ...
    train_img_dir = os.path.join(root_dir, "data/processed_data/train/img")
    train_mask_dir = os.path.join(root_dir, "data/processed_data/train/mask")
    val_img_dir = os.path.join(root_dir, "data/processed_data/val/img")
    val_mask_dir = os.path.join(root_dir, "data/processed_data/val/mask")
