...
fn main() {
    ...
    let models_dir_default = manifest_dir.parent().unwrap().join("models").join("TinyAgri");
    let test_img_dir_default = manifest_dir.parent().unwrap().join("data").join("TinyAgri").join("test").join("img");
